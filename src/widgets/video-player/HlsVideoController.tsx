...
interface HlsVideoControllerProps {
  video: HTMLVideoElement | null;
}

export default function HlsVideoController({ video }: HlsVideoControllerProps) {
  ...
  useEffect(() => {
    ...
    console.log('HlsVideoController mounted with video:', video);
  ...
  return (
    <div className="w-full flex flex-col items-center justify-between px-6 py-4 bg-[#181818] rounded-lg shadow text-white gap-6">
      <input
        ...
        value={current}
        onChange={handleSeek}
        className="w-full accent-red-600 h-1 appearance-none bg-transparent mt-4"
        title="진행바"
        style={{
